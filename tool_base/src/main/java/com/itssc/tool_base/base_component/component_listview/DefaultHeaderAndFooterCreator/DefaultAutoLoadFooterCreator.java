...
import com.itssc.tool_base.base_component.component_listview.AutoLoad.AutoLoadFooterCreator;
...
public class DefaultAutoLoadFooterCreator extends AutoLoadFooterCreator {
    ...
    protected View getLoadView(Context context, RecyclerView recyclerView) {
        if (mAutoLoadFooter == null) {
            ...
            iv = mAutoLoadFooter.findViewById(R.id.iv);
            startLoadingAnim();
        }
    ...
    protected View getNoMoreView(Context context, RecyclerView recyclerView) {
        if (mNoMoreView == null) {
            ...
            ((TextView) mNoMoreView.findViewById(R.id.tv)).setText("没有更多了");
        }
        return mNoMoreView;
    }
