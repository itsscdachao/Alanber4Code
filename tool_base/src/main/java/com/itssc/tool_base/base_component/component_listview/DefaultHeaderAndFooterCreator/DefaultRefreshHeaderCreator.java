...
import com.itssc.tool_base.base_component.component_listview.PullToRefresh.PullToRefreshRecyclerView;
import com.itssc.tool_base.base_component.component_listview.PullToRefresh.RefreshHeaderCreator;
...
public class DefaultRefreshHeaderCreator extends RefreshHeaderCreator {
    ...
    public View getRefreshView(Context context, RecyclerView recyclerView) {
        mRefreshView = LayoutInflater.from(context).inflate(R.layout.layout_pull_refresh_head, recyclerView, false);
        iv = mRefreshView.findViewById(R.id.iv);
        tv = mRefreshView.findViewById(R.id.tv);
        return mRefreshView;
    }
