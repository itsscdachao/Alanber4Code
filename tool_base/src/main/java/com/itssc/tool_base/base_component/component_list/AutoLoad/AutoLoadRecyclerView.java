package com.itssc.tool_base.base_component.component_list.AutoLoad;
...
import com.itssc.tool_base.base_component.component_list.DefaultHeaderAndFooterCreator.DefaultAutoLoadFooterCreator;
import com.itssc.tool_base.base_component.component_list.PullToLoad.OnLoadListener;
...
public class AutoLoadRecyclerView extends PullToRefreshRecyclerView {
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && !mIsLoading && mLoadMoreEnable && mLoadView != null) {
            ...
            if (layoutManager.getChildCount() > 0 && lastVisibleItemPosition >= layoutManager.getItemCount() - 1 && layoutManager.getItemCount() > layoutManager.getChildCount() && !mNoMore) {
                mIsLoading = true;
