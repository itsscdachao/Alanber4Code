package com.itssc.tool_widget.commonview.DragView;
...
public class DragView extends AppCompatImageView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray mTypedAttay = context.obtainStyledAttributes(attrs, R.styleable.dragview);
        customIsAttach = mTypedAttay.getBoolean(R.styleable.dragview_customIsAttach, true);
        customIsDrag = mTypedAttay.getBoolean(R.styleable.dragview_customIsDrag, true);
        mTypedAttay.recycle();
    }
