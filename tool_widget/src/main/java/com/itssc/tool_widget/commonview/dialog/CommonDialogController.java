...
public class CommonDialogController {
    ...
    private Button btn_ok;//右侧确定按钮
    private Button btn_cancel;//左侧取消按钮

    CommonDialogController(IDialog dialog) {
    ...
    public void setChildView(View view) {
        setDialogView(view);
        dealDefaultDialog(mPositiveButtonListener, mNegativeButtonListener, titleStr, contentStr, showBtnLeft, negativeStr, showBtnRight, positiveStr);
    }

    void dealDefaultDialog(IDialog.OnClickListener positiveBtnListener, IDialog.OnClickListener negativeBtnListener, String titleStr, String contentStr, boolean showBtnLeft, String negativeStr, boolean showBtnRight, String positiveStr) {
    ...
    public static class CommonParams {
        ...
        void apply(CommonDialogController controller) {
