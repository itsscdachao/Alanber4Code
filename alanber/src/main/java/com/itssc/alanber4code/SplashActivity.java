...
//                    @Override
//                    public void onClick(IDialog dialog) {
//                        Toast.makeText(getApplication(), "立即分享", Toast.LENGTH_SHORT).show();
//                        dialog.dismiss();
//                    }
//                },
...
//                    @Override
//                    public void onClick(IDialog dialog) {
//                        Toast.makeText(getApplication(), "有钱不要", Toast.LENGTH_SHORT).show();
//                        dialog.dismiss();
//                    }
//                });
...
//                        //监听dialog dismiss的回调
//                        Toast.makeText(getApplication(), "dissmiss", Toast.LENGTH_SHORT).show();
//                    }
//                })
...
//                                }
//                                dialog.dismiss();
//                                Toast.makeText(getApplication(), editTextStr, Toast.LENGTH_SHORT).show();
//                            }
//                        });
//                    }
//                }).show();
...
//                            @Override
//                            public void onClick(View v) {
//                                Toast.makeText(getApplication(), "拍照", Toast.LENGTH_SHORT).show();
//                                dialog.dismiss();
//                            }
//                        });
//
...
//                            @Override
//                            public void onClick(View v) {
//                                Toast.makeText(getApplication(), "相册选取", Toast.LENGTH_SHORT).show();
//                                dialog.dismiss();
//                            }
//                        });
//
...
//                .setGravity(Gravity.BOTTOM).show();
    ...
    public void showDefaultDialogTwo(View view) {
        CommonDialogUtil.createDefaultDialog(this, "分享", "分享此接单码，您和乘客都将获得现金红包！",
                "立即分享", new IDialog.OnClickListener() {
                    @Override
                    public void onClick(IDialog dialog) {
                        Toast.makeText(SplashActivity.this, "立即分享", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                },
                "有钱不要", new IDialog.OnClickListener() {
                    @Override
                    public void onClick(IDialog dialog) {
                        Toast.makeText(SplashActivity.this, "有钱不要", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                });
    }
    ...
    public void showBaseUseDialog(View view) {
        new CommonDialog.Builder(this)
                ...
                .setOnDismissListener(new IDialog.OnDismissListener() {
                    ...
                    public void onDismiss(IDialog dialog) {
                        //监听dialog dismiss的回调
                        Toast.makeText(SplashActivity.this, "dismiss回调", Toast.LENGTH_SHORT).show();
                    }
                })
                .setBuildChildListener(new IDialog.OnBuildChildViewListener() {
                    //设置子View
                    ...
                    public void onBuildChildView(final IDialog dialog, View view, int layoutRes) {
                        ...
                        btn_ok.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                dialog.dismiss();
                                Toast.makeText(SplashActivity.this, editTextStr, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }).show();
    ...
    public void showLoadingDialog(View view) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                CommonDialogUtil.closeLoadingDialog(SplashActivity.this);
            }
        }, 5000);
    }
                ...
                .setBuildChildListener(new IDialog.OnBuildChildViewListener() {
                    ...
                    public void onBuildChildView(final IDialog dialog, View view, int layoutRes) {
                        ...
                        btn_take_photo.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(SplashActivity.this, "拍照", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        });
                        ...
                        btn_select_photo.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(SplashActivity.this, "相册选取", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        });
        ...
        dialog = new CommonDialog.Builder(this)
                ...
                .setBuildChildListener(new IDialog.OnBuildChildViewListener() {
                    ...
                    public void onBuildChildView(final IDialog dialog, View view, int layoutRes) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(SplashActivity.this, LinearLayoutManager.HORIZONTAL, false));
    ...
    class ShareAdapter extends RecyclerView.Adapter<ShareAdapter.ShareHolder> {
        ...
        public void onBindViewHolder(ShareHolder holder, int position) {
            holder.ll_share.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(SplashActivity.this, "分享", Toast.LENGTH_SHORT).show();
                    dismissDialog();
                }
            });
        }
