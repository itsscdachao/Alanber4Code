...
public class CrashActivity extends AppCompatActivity {
                ...
                menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (id == R.id.menu_copy_text) {
                            ...
                            if (ContextCompat.checkSelfPermission(CrashActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED || ContextCompat.checkSelfPermission(CrashActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
    ...
    private File BitmapToFile(Bitmap bitmap) {
        ...
        File imageFile = new File(path, "CrashSpider-" + df.format(model.getTime()) + ".jpg");
        try {
    ...
    private void shareImage() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            Uri contentUri = FileProvider.getUriForFile(getApplicationContext(), getApplicationContext().getPackageName() + ".CrashSpiderFileProvider", file);
